<template>
    ...
    <div class="shadow-lg bg-body rounded mb-3">
        <div class="card bg-light mb-3" >
            <div class="card-header text-center"><h5 class="mt-1">HORARIO - DOCENTE (PRÁCTICA)</h5></div>
            <div class="card-body">
                <div class="container d-flex justify-content-around">
                    ...
                    <div>
                        <h6 class="card-text">Rotación: <strong class="mx-3">{{rotacion}}</strong></h6>
...
export default {
    ...
    data () {
        return {
          ...
          rotacion: this.$route.params.rotacion,
    ...
    methods: {
        ...
        //         this.gestion = this.gestiones.descripcion
        //         this.id_gestion = this.gestiones.id_gestion
        //         return this.gestiones.id_gestion
        //     } catch (error) {
        //       console.log(error);
        //     }
        ...
        async getDetallesAulasTotal() {   //get All
            ...
            try {
                // if (id_aula !== null) {
                    // let res = await asignacionService.getDetallesAula(id_gestion, id_aula)  
                    //console.log('el id_personal y el id_gestion es: ', this.id_personal, this.id_gestion)
                    let res = await asignacionService.getHorarioAulaDocenteGestion(this.id_personal, this.id_gestion)
